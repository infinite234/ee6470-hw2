...
void Testbench::do_gauss() {
  ...
  double R[MASK_Y*MASK_X] ={0}, G[MASK_Y*MASK_X] = {0}, B[MASK_Y*MASK_X] ={0}; // color of R, G, B
  ...
  o_rst.write(true);
   // implement a queue of size 3 for cache
      double Red_prev[MASK_Y*MASK_X] = {0.0}; double Green_prev[MASK_Y*MASK_X] = {0.0}; double Blue_prev[MASK_Y*MASK_X] = {0.0};
      int cnt =0;
  for (y = 0; y != height; ++y) {
    for (x = 0; x != width; ++x) {
